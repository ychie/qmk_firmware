...
[_RAISE] = LAYOUT_planck_grid(
    ...
    _______, KC_UNDS,  KC_EQL, KC_PLUS, KC_MINS, KC_LCBR, KC_RCBR, _______, _______, KC_LBRC, KC_RBRC, _______,
...
[_LOWER] = LAYOUT_planck_grid(
    KC_DEL,  KC_F1,   KC_F2,   KC_F3,   KC_F4,   _______, _______, KC_WH_D, KC_WH_U, _______, _______, KC_BSPC,
    KC_GRV,  KC_F5,   KC_F6,   KC_F7,   KC_F8,   _______, KC_MS_L, KC_MS_D, KC_MS_U, KC_MS_R, _______, _______,
    _______, KC_F9,   KC_F10,  KC_F11,  KC_F12,  _______, KC_BTN1, KC_BTN2, _______, _______, _______, _______,
    _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______
),
